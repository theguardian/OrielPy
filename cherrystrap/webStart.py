...
def initialize(options={}):
    ...
    cherrypy.tree.mount(apiServe.applicationlog(), cherrystrap.HTTP_ROOT+'/api/v1/applicationlog',
        {'/': {'request.dispatch': cherrypy.dispatch.MethodDispatcher()}})
    cherrypy.tree.mount(apiServe.static(), cherrystrap.HTTP_ROOT+'/api/v1/static',
        {'/': {'request.dispatch': cherrypy.dispatch.MethodDispatcher()}})
    cherrypy.tree.mount(apiServe.diskio(), cherrystrap.HTTP_ROOT+'/api/v1/diskio',
        {'/': {'request.dispatch': cherrypy.dispatch.MethodDispatcher()}})
    cherrypy.tree.mount(apiServe.sysfiles(), cherrystrap.HTTP_ROOT+'/api/v1/sysfiles',
        {'/': {'request.dispatch': cherrypy.dispatch.MethodDispatcher()}})
    cherrypy.tree.mount(apiServe.cpuload(), cherrystrap.HTTP_ROOT+'/api/v1/cpuload',
        {'/': {'request.dispatch': cherrypy.dispatch.MethodDispatcher()}})
    cherrypy.tree.mount(apiServe.memload(), cherrystrap.HTTP_ROOT+'/api/v1/memload',
        {'/': {'request.dispatch': cherrypy.dispatch.MethodDispatcher()}})
    cherrypy.tree.mount(apiServe.swapload(), cherrystrap.HTTP_ROOT+'/api/v1/swapload',
        {'/': {'request.dispatch': cherrypy.dispatch.MethodDispatcher()}})
    cherrypy.tree.mount(apiServe.partitions(), cherrystrap.HTTP_ROOT+'/api/v1/partitions',
        {'/': {'request.dispatch': cherrypy.dispatch.MethodDispatcher()}})
    cherrypy.tree.mount(apiServe.networkload(), cherrystrap.HTTP_ROOT+'/api/v1/networkload',
        {'/': {'request.dispatch': cherrypy.dispatch.MethodDispatcher()}})
    cherrypy.tree.mount(apiServe.logs(), cherrystrap.HTTP_ROOT+'/api/v1/logs',
        {'/': {'request.dispatch': cherrypy.dispatch.MethodDispatcher()}})
    cherrypy.tree.mount(apiServe.systemlogs(), cherrystrap.HTTP_ROOT+'/api/v1/systemlogs',
        {'/': {'request.dispatch': cherrypy.dispatch.MethodDispatcher()}})
    cherrypy.tree.mount(apiServe.processes(), cherrystrap.HTTP_ROOT+'/api/v1/processes',
        {'/': {'request.dispatch': cherrypy.dispatch.MethodDispatcher()}})
    cherrypy.tree.mount(apiServe.sysprocesses(), cherrystrap.HTTP_ROOT+'/api/v1/sysprocesses',
        {'/': {'request.dispatch': cherrypy.dispatch.MethodDispatcher()}})
    cherrypy.tree.mount(apiServe.rules(), cherrystrap.HTTP_ROOT+'/api/v1/rules',
        {'/': {'request.dispatch': cherrypy.dispatch.MethodDispatcher()}})
    cherrypy.tree.mount(apiServe.health(), cherrystrap.HTTP_ROOT+'/api/v1/health',
        {'/': {'request.dispatch': cherrypy.dispatch.MethodDispatcher()}})
