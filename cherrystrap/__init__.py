        ...
        try:
            ...
            if orielpy.NOTIFICATION_TYPE != "disabled":
                if orielpy.NOTIFICATION_TYPE == 'interval' and orielpy.NOTIFICATION_UNITS == 'hours':
                    ...
                    healthNotify = IntervalTrigger(weeks=0, days=0, hours=0, minutes=orielpy.NOTIFICATION_FREQUENCY, seconds=0, start_date=None, end_date=None, timezone=None)
                elif orielpy.NOTIFICATION_TYPE == 'cron':
                    try:
                        cronList = orielpy.NOTIFICATION_CRON.split(' ')
                        minute = cronList[0]
                        hour = cronList[1]
                        DOM = cronList[2]
                        MOY = cronList[3]
