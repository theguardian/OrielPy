...
from lib.oauthlib import common
from lib.oauthlib.uri_validate import is_absolute_uri
...
class AuthorizationCodeGrant(GrantTypeBase):
    ...
    def create_authorization_response(self, request, token_handler):
        ...
        A few examples::
            ...
            >>> from lib.oauthlib.common import Request
            >>> from lib.oauthlib.oauth2 import AuthorizationCodeGrant, BearerToken
