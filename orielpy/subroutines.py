...
from orielpy import database, logger
...
class subroutines:
    ...
    def sysfiles_subroutine(self):
        ...
        try:
            with open(os.path.join(orielpy.PSEUDOFILE_FOLDER, orielpy.CPU_FAN_FILE), 'r'): pass
        ...
        try:
            with open(os.path.join(orielpy.PSEUDOFILE_FOLDER, orielpy.SYS_FAN_FILE), 'r'): pass
            fan2_file = open(os.path.join(orielpy.PSEUDOFILE_FOLDER, orielpy.SYS_FAN_FILE), 'r')
            fan2 = fan2_file.read()
            fan2_file.close()
        except:
            fan2 = 0
        ...
        try:
            with open(os.path.join(orielpy.PSEUDOFILE_FOLDER, orielpy.CPU_TEMP_FILE), 'r'): pass
            temp1_file = open(os.path.join(orielpy.PSEUDOFILE_FOLDER, orielpy.CPU_TEMP_FILE), 'r')
        ...
        try:
            with open(os.path.join(orielpy.PSEUDOFILE_FOLDER+orielpy.SYS_TEMP_FILE), 'r'): pass
            temp3_file = open(os.path.join(orielpy.PSEUDOFILE_FOLDER+orielpy.SYS_TEMP_FILE), 'r')
