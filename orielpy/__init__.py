...
def initialize():
    ...
    with INIT_LOCK:
        ...
        CPU_INFO_PATH = check_setting_str(CFG, 'Server', 'cpu_info_path', '')
        PSEUDOFILE_FOLDER = check_setting_str(CFG, 'Server', 'pseudofile_folder', '')
        NUM_INTERNAL_DISK_CAPACITY = int(check_setting_str(CFG, 'Server', 'num_internal_disk_capacity', '1'))
        ...
        CPU_TEMP_FILE = check_setting_str(CFG, 'Server', 'cpu_temp_file', '')
